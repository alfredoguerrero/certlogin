...
<head>
	...
	<title>Menu_UsuarioNormal</title>
...
<body>
	...
	<div class="sidebar">
		...
		<ul>
			<li><a href="MenuUsuarioNormal.php"><i class="fa fa-fw fa-home"></i> Inicio</a></li>
			<li><a href="perfilUsuario.php"><i class="fa fa-fw fa-user"></i>Perfil</a></li>
			<li><a href="consultarIncid_Usuario.php"><i class="fa fa-fw fa-search"></i>Consultar incidencias</a></li>
...
<section>
        ...
        </form><!-- La tabla mostrara todas las incidencias y solo se podra registrar la solucion mas no modificar nada ni eliminar-->
